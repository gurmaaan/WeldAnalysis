...
class CAgilent34401ErrorReporter :
	public CErrorReporter
{
public:
	CAgilent34401ErrorReporter(ICallContextProvider* pCallContextProvider)
		: CErrorReporter(__uuidof(Agilent34401), pCallContextProvider)
	{
	}
	...
	HRESULT IoError(const CString& strDetails) const
	{
		...
		if (hr == S_OK)
		{
			...
			if (SUCCEEDED(hr))
			{
				...
				hr = ReportEx(IDS_E_AGILENT34401_IO_GENERAL, LPCTSTR(strDetails), LPCTSTR(strDescription));
			}
			else
			{
				hr = ReportEx(IDS_E_AGILENT34401_IO_GENERAL, LPCTSTR(strDetails), _T(""));
			}
	...
	HRESULT IoTimeoutError(const CString& strDetails) const
	{
		...
		if (hr == S_OK)
		{
			...
			if (SUCCEEDED(hr))
			{
				...
				hr = ReportEx(IDS_E_AGILENT34401_IO_TIMEOUT, LPCTSTR(strDetails), LPCTSTR(strDescription));
			}
			else
			{
				hr = ReportEx(IDS_E_AGILENT34401_IO_TIMEOUT, LPCTSTR(strDetails), _T(""));
			}
	...
	{ return ReportEx(IDS_E_AGILENT34401_MODEL_NOT_SUPPORTED, strDetails, strModel); }
	...
	{ return ReportEx(IDS_E_AGILENT34401_PERSONALITY_NOT_ACTIVE, strDetails); }
	
	// "Personality is not installed."
	virtual HRESULT PersonalityNotInstalled(const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_AGILENT34401_PERSONALITY_NOT_INSTALLED, strDetails); }
	
	// "Personality is not licensed."
	virtual HRESULT PersonalityNotLicensed(const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_AGILENT34401_PERSONALITY_NOT_LICENSED, strDetails); }
	
	// "Error in call to wrapped driver: ViStatus = %1."
	virtual HRESULT WrappedDriverError(LPCTSTR pszParam1, const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_AGILENT34401_WRAPPED_DRIVER_ERROR, strDetails, pszParam1); }
	
	// "Maximum time for the operation to complete has been exceeded: %1"
	virtual HRESULT MaxTimeExceeded(LPCTSTR pszParam1, const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_AGILENT34401_MAX_TIME_EXCEEDED, strDetails, pszParam1); }
	
	// "Does not support this feature: %1"
	virtual HRESULT NotSupported(LPCTSTR pszParam1, const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_AGILENT34401_NOT_SUPPORTED, strDetails, pszParam1); }
	
	// "The trigger source is not set to software trigger."
	virtual HRESULT IviDmmTriggerNotSoftware(const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_IVIDMM_TRIGGER_NOT_SOFTWARE, strDetails); }
	
	// "Max Time Exceeded"
	virtual HRESULT IviDmmMaxTimeExceeded(const CString& strDetails = _T(""))
	{ return ReportEx(IDS_E_IVIDMM_MAX_TIME_EXCEEDED, strDetails); }
	
	// "Over Range"
	virtual HRESULT IviDmmOverRange(const CString& strDetails = _T(""))
	{ return ReportEx(IDS_S_IVIDMM_OVER_RANGE, strDetails); }
...
protected:
	...
	virtual HRESULT SetError(UINT uResid, const CString& strError) const override
	{
		...
		CComBSTR bstrHelpFileName = OLESTR("Agilent34401.chm");
		DWORD dwDriverHelpContextID = 0;
		switch (uResid)
		{
			case IDS_E_AGILENT34401_PERSONALITY_NOT_ACTIVE:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_PERSONALITY_NOT_ACTIVE;
				break;
			case IDS_E_AGILENT34401_PERSONALITY_NOT_INSTALLED:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_PERSONALITY_NOT_INSTALLED;
				break;
			case IDS_E_AGILENT34401_PERSONALITY_NOT_LICENSED:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_PERSONALITY_NOT_LICENSED;
				break;
			case IDS_E_AGILENT34401_IO_GENERAL:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_IO_GENERAL;
				break;
			case IDS_E_AGILENT34401_IO_TIMEOUT:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_IO_TIMEOUT;
				break;
			case IDS_E_AGILENT34401_MODEL_NOT_SUPPORTED:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_MODEL_NOT_SUPPORTED;
				break;
			case IDS_E_AGILENT34401_WRAPPED_DRIVER_ERROR:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_WRAPPED_DRIVER_ERROR;
				break;
			case IDS_E_AGILENT34401_MAX_TIME_EXCEEDED:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_MAX_TIME_EXCEEDED;
				break;
			case IDS_E_AGILENT34401_NOT_SUPPORTED:
				dwDriverHelpContextID = 0;
				hrDriverError = E_AGILENT34401_NOT_SUPPORTED;
				break;
			case IDS_E_IVIDMM_TRIGGER_NOT_SOFTWARE:
				dwDriverHelpContextID = 3;
				hrDriverError = E_IVIDMM_TRIGGER_NOT_SOFTWARE;
				break;
			case IDS_E_IVIDMM_MAX_TIME_EXCEEDED:
				dwDriverHelpContextID = 3;
				hrDriverError = E_IVIDMM_MAX_TIME_EXCEEDED;
				break;
			case IDS_S_IVIDMM_OVER_RANGE:
				dwDriverHelpContextID = 3;
				hrDriverError = S_IVIDMM_OVER_RANGE;
				break;
